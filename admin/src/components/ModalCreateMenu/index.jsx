      ...
      <Form form={form} name="Menus" onFinish={handleOk}>
        <Row gutter={16}>
          <Col span={12}>
            ...
            {selectedMenu && (
              <>
                <label htmlFor="unit" className="block text-sm font-bold mb-1">
            ...
            <Form.Item
              ...
              style={{ marginBottom: 10 }}
              rules={[
                { required: true, message: "Giá món ăn không được để trống!" },
                {
                  pattern: /^([1-9]\d*)$/,
            ...
            <label htmlFor="discount" className="block text-sm font-bold mb-1">
          ...
          <Col span={12}>
            <label htmlFor="classify" className="block text-sm font-bold mb-1">
